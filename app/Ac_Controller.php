...
require_once 'Ac_Error.php';
require_once 'Ac_ActionClass.php';
require_once 'Ac_ActionForm.php';
require_once 'Ac_ViewClass.php';

/**
 *  Ac application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Ac
 */
class Ac_Controller extends Ethna_Controller
{
    /**#@+
     *  @access private
     */
